...
Подробные профили тестирования производительности CPU и памяти (с упором на оптимизированное горячее выполнение JIT-модулей со скоростью около ~38 мкс) задокументированы в файле [Benchmarks & Profiling Profile](docs/benchmarks.md).
